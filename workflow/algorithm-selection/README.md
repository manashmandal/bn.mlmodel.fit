...
- অ্যালগরিদম সিলেক্ট করব কোন কোন ক্রাইটেরিয়ার ভিত্তিতে
  _ অ্যালগরিদম বাছাইয়ের জন্য সল্যুশন স্টেটমেন্ট ব্যবহার করব
  _ বেস্ট অ্যালগরিদম কোনটা হবে সেটা নিয়ে আলোচনা করব
  _ প্রাথমিক অ্যালগরিদম বাছাই করব
...
![math_model](https://i.imgur.com/bvEvpSY.png)
...
- Ensemble Algorithms:
  _ এগুলো স্পেশাল অ্যালগরিদম, কারণ একেকটা Ensemble Algorithm অনেকগুলা অ্যালগরিদমের সমষ্টি হয়ে থাকে।
  _ খুবই ভাল পার্ফর্মেন্স \* ডিবাগিং করা সুবিধাজনক নয়
...
- প্রতিটি ফিচার বা ইনপুট ভ্যারিয়েবল (আলোচ্য সমস্যার ক্ষেত্রে: no of preg, insulin, ইত্যাদি) সমান গুরুত্বপূর্ণ। _তারমানে এখানে Blood Pressure আর BMI (Body Mass Index) সমান গুরুত্বপূর্ণ (পাশাপাশি সব ভ্যারিয়েবল-ই)।_
...
- ডেটা চেঞ্জ হলেও মডেল স্টেবল থাকে \* ডিবাগিং করা তুলনামূলক সহজ
...
- Naive Bayes সিলেক্ট করলাম ট্রেনিংয়ের জন্য, কারণ \* সহজ, ফাস্ট ও স্টেবল
