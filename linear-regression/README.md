...
![graph](https://i.imgur.com/OyvZcmM.png)
...
$$\text{Khaoa} =  \frac{\text{Aye} - \text{10k}}{\text{10k}} \times 5$$
...
![scatter](https://i.imgur.com/qoJFZI7.png)
...
![hypothesis](https://i.imgur.com/jMYPlLv.png)
...
ধরি আমাদের Hypothesis হচ্ছে, $h_{0}(x) = \theta_{0} + \theta_{1} * x$
...
![scatter_plot](https://i.imgur.com/JuUMGnz.png)

আমাদের যেটা করতে হবে এইরকম একটা স্ট্রেইট লাইন এই ডেটার মধ্যে `Fit` করতে হবে।

![scatter_plot_fitline](https://i.imgur.com/HL7f2Po.png)
...
![scatter1](https://i.imgur.com/SaGyPXc.png)

### ধরি $\theta_{0} = 0$ এবং $\theta_{1} = 120$

তাহলে গ্রাফ আসবে এইরকম,

![scatter2](https://i.imgur.com/A8OIJGL.png)
...
এবার আমরা দুইটা প্যারামিটার ব্যবহার করে আবার গ্রাফ প্লট করার চেষ্টা করি। 
 ...
 ![hypo3](https://i.imgur.com/cOJRMfR.png)
 ...
 ![hypo4](https://i.imgur.com/JhgiQ06.png)
 ...
 কস্ট ফাংশন যেটা বলতে চায়, সেটা হল; আমরা প্রতি Observation এর জন্য Error বের করব (Error = Hypothesis Value - Real Value), সেই Error কে বর্গ করব। এভাবে প্রতি $\text{Error}^{2}$ এর যোগফল বের করব (m সংখ্যক $\text{Error}^{2}$ এর যোগফল)। তারপর তাকে $\frac{1}{2 \times m}$ দিয়ে গুণ দিব। 
...
* *RSS* এর সূত্র হল $\text{RSS} = \sum_{i=1}^{m}\text{Residual}^{2}$   
 
### Cost Function এর মেথড হিসেবে OLS ব্যবহার করা হয়েছে কেন?

**খুবই গুরুত্বপূর্ণ একটি প্রশ্ন এবং সচরাচর জিজ্ঞাস্য নয়। Cost Function হিসেবে OLS ব্যবহার করার মূল কারণ $y = x^{2}$ এর গ্রাফ Parabolic হয়। প্যারাবলিক ফাংশন থেকে Cost Estimation করাটা খুবই সহজ। আর $\text{Error}^{2}$ এর গ্রাফ প্যারাবলিক হবে সেটাই স্বাভাবিক।**
